...
public class ShowFollower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref=dbref.getReference().child("Follow").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("followers");
        uref=FirebaseDatabase.getInstance().getReference().child("User");
        mSearchBtn = (ImageButton) findViewById(R.id.searchbtn);
        mSearchField = findViewById(R.id.search_here);
        myid=FirebaseAuth.getInstance().getCurrentUser().getUid();
        ref1=FirebaseDatabase.getInstance().getReference().child("User");

        recyclerView=findViewById(R.id.follower_list);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(ShowFollower.this, ProfilePage.class);
                            ...
                            Holder.follow.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    if (Holder.follow.getText().toString().equals("FOLLOW")) {
                                        ...
                                        uref2 = FirebaseDatabase.getInstance().getReference().child("Follow").child(uid)
                                        ...
                                        FirebaseDatabase.getInstance().getReference().child("Follow").child(uid).child("followers")
    ...
    private void getFollowers()
    {
        ...
        DatabaseReference db=FirebaseDatabase.getInstance().getReference().child("Follow").child(myid).child("followers");
