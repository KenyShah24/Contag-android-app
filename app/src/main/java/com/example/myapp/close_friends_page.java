...
public class close_friends_page extends AppCompatActivity {
   ...
   // private List<String> friends;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref=dbref.getReference().child("Follow").child( FirebaseAuth.getInstance().getCurrentUser().getUid())
                .child("following");

        //ref=dbref.getReference().child("Close_Friends").child( FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Friends");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(close_friends_page.this, ProfilePage.class);
                            ...
                            Holder.follow.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    if (Holder.follow.getText().toString().equals("Follow"))
                                        //if (Holder.follow.getText().toString().equals("Close_Friends"))
                                    {
                                        uref1 = FirebaseDatabase.getInstance().getReference().child("Follow").child(fuser.getUid())
                                                .child("following").child(uid);
                                        //   uref1 = FirebaseDatabase.getInstance().getReference().child("Close_Friends").child(fuser.getUid()).child("Friends").child(uid);

                                        uref1.setValue(true);
                                        uref2 = FirebaseDatabase.getInstance().getReference().child("Follow").child(uid).child("followers").child(fuser.getUid());

                                        //uref2 = FirebaseDatabase.getInstance().getReference().child("Close_Friends").child(uid).child("Not_Friends").child(fuser.getUid());
                                        uref2.setValue(true);
                                    } else {
                                        //FirebaseDatabase.getInstance().getReference().child("Close_Friends").child(fuser.getUid()).child("Friends").removeValue();
                                        //FirebaseDatabase.getInstance().getReference().child("Close_Friends").child(uid).child("Not_Friends").child(fuser.getUid()).removeValue();
                                        FirebaseDatabase.getInstance().getReference().child("Follow").child(fuser.getUid()).child("following").removeValue();
    ...
    {
        //DatabaseReference ref=FirebaseDatabase.getInstance().getReference().child("Close_Friends").child(fuser.getUid()).child("Friends");
    ...
    private void getFollowers()
    {
       ...
       // DatabaseReference db=FirebaseDatabase.getInstance().getReference().child("Close_Friends").child(myid).child("Friends");
